...
<head>
    ...
    <title>Job Junction | Connecting Skills with Opportunities.</title>
...
<body data-instant-intensity="mousedown">
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
            <div class="container">
                <a class="navbar-brand" href="{{ route('home') }}">JobJunction</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-0 ms-sm-0 me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('freelancers') }}">Find
                                Freelancers</a>
                        </li>
