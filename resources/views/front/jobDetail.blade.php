                    ...
                    <div class="job_details_header">
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            <div class="jobs_left d-flex align-items-center">
                                <img src="{{ asset($job->image) }}" alt="Job Image" class="img-fluid mb-3" style='max-width:200px; height:200px;'>
                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <form action="{{ route('account.acceptApplication', $application->id) }}" method="POST">
                                                            @csrf
                                                            <button type="submit" class="dropdown-item"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Accept</button>
                                                        </form>
                                                    </li>
                                                    <li>
                                                        <form action="{{ route('account.rejectApplication', $application->id) }}" method="POST">
                                                            @csrf
                                                            <button type="submit" class="dropdown-item"><i class="fa fa-times" aria-hidden="true"></i>&nbsp;Reject</button>
                                                        </form>
                                                    </li>
                                                </ul>
                                            </div>
