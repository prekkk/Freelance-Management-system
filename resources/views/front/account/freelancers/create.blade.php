    ...
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <form action="{{ route('account.createFreelancer') }}" method="post" id="createFreelancerForm" enctype="multipart/form-data">
                    @csrf
...
$("#createFreelancerForm").submit(function(e){
    ...
    $.ajax({
        url: '{{ route("account.createFreelancer") }}',
        type: 'POST',
        dataType: 'json',
        processData: false, 
        contentType: false,
        ...
        success: function(response) {
            if(response.status == true) {
                ...
                window.location.href="{{ route('account.saveFreelancer') }}";
